    ...
    >
      <View style={[styles.header, colorScheme === "dark" ? styles.headerDark : styles.headerLight]}>
        {router.canGoBack() ? (
          ...
          >
            <Ionicons name="arrow-back" size={24} color={colorScheme === "dark" ? "gray" : "black"} />
          </Pressable>
        ) : (
          <Pressable
            style={styles.menuButton}
      ...
      <ScrollView style={styles.scrollView}>
        ...
        <View style={styles.repliesHeader}>
          <Text style={colorScheme === "dark" ? styles.repliesHeaderDark : styles.repliesHeaderLight}>Replies</Text>
        </View>
        <Post
          item={{
            id: "2",
