    ...
    >
      <View style={[styles.header, colorScheme === "dark" ? styles.headerDark : styles.headerLight]}>
        ...
        {isLoggedIn && (
          ...
          >
            <Ionicons name="menu" size={24} color={colorScheme === "dark" ? "gray" : "black"} />
          </Pressable>
        )}
      ...
      <View style={styles.profile}>
        <View style={styles.profileHeader}>
          ...
          <Text style={[styles.profileName, colorScheme === "dark" ? styles.profileNameDark : styles.profileNameLight]}>
            {user?.name}
          </Text>
          <Text
            style={[{ marginBottom: 16 }, colorScheme === "dark" ? styles.profileTextDark : styles.profileTextLight]}
          >
            {user?.id}
          </Text>
          <Text style={[colorScheme === "dark" ? styles.profileTextDark : styles.profileTextLight]}>
            {user?.description}
          </Text>
        </View>
            ...
            >
              <Text
                style={[
                  ...
                  colorScheme === "dark" ? styles.actionButtonTextDark : styles.actionButtonTextLight,
                ]}
              >
                Edit profile
              </Text>
      ...
      {user && (
        <EditProfileModal visible={isEditModalVisible} onClose={handleCloseEditModal} initialProfileData={user} />
      )}
      <MaterialTopTabs
        screenOptions={{
          lazy: true,
