      ...
      <View style={styles.tabBar}>
        <View>
          <TouchableOpacity
            style={[
              styles.tabButton,
              colorScheme === "dark" ? styles.tabButtonDark : styles.tabButtonLight,
              pathname === "/activity" &&
                (colorScheme === "dark" ? styles.tabButtonActiveDark : styles.tabButtonActiveLight),
            ]}
          ...
          >
            <Text
              style={[
                ...
                colorScheme === "dark" ? styles.tabButtonTextDark : styles.tabButtonTextLight,
              ]}
            >
              All
            </Text>
