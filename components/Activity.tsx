...
export default function ActivityItem({
  ...
  const handleItemPress = () => {
    if (type === "follow" || type === "followed") {
      ...
      console.log(`No postId for activity type: ${type}, navigating to profile`);
      router.push(`/${username}`);
    }
  };
  ...
  return (
    <Pressable onPress={handleItemPress} style={styles.activityItemContainer}>
      ...
      <View style={styles.activityContent}>
        ...
        {type === "followed" ? (
          <Text
            style={[styles.activityText, colorScheme === "dark" ? styles.activityTextDark : styles.activityTextLight]}
          >
            Followed you
          </Text>
        ) : (
        ...
        {reply && (
          <View style={styles.replyContainer}>
            <Text style={[styles.replyText, colorScheme === "dark" ? styles.replyTextDark : styles.replyTextLight]}>
              {reply}
            </Text>
          </View>
        )}
